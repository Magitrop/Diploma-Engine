...
namespace engine
{
	...
	void GladMeshAccessor::setVertices(std::vector<Vertex>&& vertices)
	{
		m_impl->setVertices(std::move(vertices));
	}
	...
	void GladMeshImpl::setVertices(std::vector<Vertex>&& vertices)
	{
